...
<body class="bg-slate-50 flex flex-col min-h-screen font-sans">
    ...
    <main class="flex-grow flex items-center justify-center p-6 text-center">
        <div class="bg-white p-12 rounded-3xl shadow-2xl max-w-lg w-full border-b-8 border-indigo-600">
            ...
            <a href="../index.html" class="inline-block w-full bg-indigo-600 hover:bg-indigo-700 text-white font-black py-4 px-8 rounded-2xl transition-all shadow-lg hover:shadow-indigo-500/30">
                ANA SAYFAYA DÖN
            </a>
        </div>
    </main>
...
<?php
    ...
    header("Location: ../frontend/login.html?hata=1");
    exit();
}
?>